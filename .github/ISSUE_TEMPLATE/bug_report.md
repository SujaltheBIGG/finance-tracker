...
about: Open a bug report when you experience broken functionality within the latest
  version of the Founder Finance app
...
- [ ] I have searched [existing issues](https://github.com/SujaltheBIGG/finance-tracker/issues?q=is:issue) and [discussions](https://github.com/SujaltheBIGG/finance-tracker/discussions) to ensure this is not a duplicate issue
    
### How are you using Founder Finance?
...
- Self hosted app commit SHA (find in user menu): [enter commit sha here]
  - [ ] I have confirmed that my app's commit is the latest version of Founder Finance
...
Be as specific as possible so Founder Finance contributors can quickly reproduce the bug you're experiencing.
